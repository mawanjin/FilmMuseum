...
public class BusinessActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv=(ImageView) findViewById(R.id.business_iv);
		bm=BitmapFactory.decodeResource(getResources(), R.drawable.business);
	...
	protected void onStop() {
		Log.v("HTTWs", "businessActivity进入onstop");
		super.onStop();
	}
	
	protected void onDestroy() {
		Log.v("HTTWs", "businessActivity进入ondestroy");
