...
public class SupServicesActivity extends Activity implements OnClickListener {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				case 0:
					...
					break;
				case 1:
					intent.setClass(getApplicationContext(), StudioStarActivity.class);
					startActivity(intent);
					break;
				case 2:
					intent.setClass(getApplicationContext(), ShopsActivity.class);
					startActivity(intent);
					break;
				default:
					break;
